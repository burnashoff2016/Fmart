    ...
    <div className="site-shell min-h-screen">
      ...
      <main className="px-6 py-36 text-center">
        <section className="cart-shell relative mx-auto max-w-xl overflow-hidden rounded-[2rem] p-10">
          <div className="absolute -right-16 -top-16 h-44 w-44 rounded-full bg-[#ffd600]/16 blur-3xl" />
          <div className="relative">
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#ffd600] text-[#111315] shadow-[0_0_30px_rgba(255,214,0,0.28)]">
